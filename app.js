    ...
    //         var line_current_top = parseInt(line.css('margin-left'));
    //         if (line_current_top > container_width) {
    //             line_current_top = 600;
    //         }
    //         line.css('margin-left', line_current_top + line_speed);
    //     };
    ...
    //     function line_down(line) {
    // var line_left = parseInt(line_1.css('margin-left'));
    //         // var line_current_top = parseInt(line.css('top'));
    //         if (line_left > container_width) {
    //             line_left = -300;
    //         }
    //         line.css('top', line_left + line_speed);
    //     }
